                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cep" onblur="getBusca()" type="text" class="form-control @error('cep') is-invalid @enderror" name="cep" value="{{ old('cep') }}" required autocomplete="cep">
...
function getBusca(){
    ...
    $.ajax({
        url : 'https://viacep.com.br/ws/87013210/json/',
        type : 'GET',
        crossDomain: true,
        dataType: 'json',
